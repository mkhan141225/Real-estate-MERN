        ...
        <main className='p-3 max-w-4xl mx-auto '>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                    ...
                    <div className='flex gap-6 flex-wrap'>
                        <div className='flex items-center gap-2'>
                            <input
                                ...
                                type="number" id="bedrooms" min="1" max="10" className='p-3 border border-gray-300 rounded-lg' required />
                            <span>Beds</span>
                        </div>
                        <div className='flex items-center gap-2'>
                            <input
                                ...
                                type="number" id="bathrooms" min="1" max="10" className='p-3 border border-gray-300 rounded-lg' required />
                            <span>Baths</span>
                        </div>
                        <div className='flex items-center gap-2'>
                            <input
                        ...
                        {formData.offer && (
                            ...
                            <input
                                ...
                                type="number" id="discountPrice" min="0" max="1000000" className='p-3 border border-gray-300 rounded-lg' required />
                            <div className='flex flex-col gap-1 items-center'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={uploading || loading} className='border rounded-lg p-3 bg-slate-800 text-white  uppercase
